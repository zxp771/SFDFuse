...
## Update
- [2025/1] Release inference code for infrared-visible image fusion, Training/Testing codes and config files are public available.
...
================================================================================
The test result of LLVIP :
                 EN      SD      SF      MI     SCD     VIF     Qabf    SSIM
SFDFuse         7.43    51.66    51.66   3.23    1.62    0.93    0.66    1.33
================================================================================
...
<img src="image//Qualitatively_LLVIP.png" width="60%" align=center />
